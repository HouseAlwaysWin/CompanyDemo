...
namespace CompanyApiService.Services.Interfaces
{
    public interface IProductService
    {
        ...
        Jsend<OneToManyMap<ProductTAndCompanyT>> FindAllByCompanyName(string searchText, int currentPage, int itemsPerPage, bool isDesc = false);
        Jsend<OneToManyMap<ProductTAndCompanyT>> FindAllByProductType(string searchText, int currentPage, int itemsPerPage, bool isDesc = false);
        Jsend<OneToManyMap<ProductTAndCompanyT>> FindAllByProductPrice(int? productPrice, int currentPage, int itemsPerPage, bool isDesc = false);
